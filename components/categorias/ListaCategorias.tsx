...
export default function ListaCategorias({ categorias, proyectoId, mesAno }: Props) {
  ...
  return (
    <div className="bg-neutral-900 rounded-2xl border border-neutral-800 divide-y divide-neutral-800">
      {categorias.map(cat => {
        ...
        return (
          <button
            ...
            className={`w-full flex items-center gap-3 px-5 py-3.5 text-left transition-colors ${
              tieneGasto ? 'hover:bg-neutral-800 cursor-pointer' : 'cursor-default opacity-50'
            }`}
          >
            {/* Icono */}
            <div
            ...
            <div className="flex-shrink-0 text-right">
              <p className={`text-sm font-semibold ${tieneGasto ? 'text-red-400' : 'text-neutral-600'}`}>
