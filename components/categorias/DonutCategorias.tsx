    ...
    return (
      <div className="flex flex-col items-center gap-3">
        <svg viewBox="0 0 200 200" className={className ?? 'w-48 h-48'}>
          <circle cx={CX} cy={CY} r={R} fill="none" stroke="#262626" strokeWidth={R - r} />
          <text x={CX} y={CY - 6} textAnchor="middle" fill="#525252" fontSize="11">Sin gastos</text>
          <text x={CX} y={CY + 10} textAnchor="middle" fill="#525252" fontSize="11">este mes</text>
        </svg>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <svg viewBox="0 0 200 200" className={className ?? 'w-52 h-52'}>
        ...
        <text x={CX} y={CY - 8} textAnchor="middle" fill="#a3a3a3" fontSize="10">Total gastos</text>
